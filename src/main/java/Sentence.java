...
public class Sentence {
    ...
    private String[] punctuationsList = {"!", ",", ".", ";", ":", "\"", "?", "”", "“", "-", "’", "'", "[", "]"};
    private ArrayList<String> punctuations;
    private ArrayList<String> nonStopWords;
    ...
    private void initialize() {
        ...
        int counter = 0;
        for (java.util.List<Token> tokens : tokenizer.segmentize(sentence)) {
            for (Token token : tokens) {
                String currentWord = token.toString();
                boolean flag = false;
                for (String str : punctuationsList) {
                    if (currentWord.indexOf(str) != -1) {
                        flag = true;
                        punctuations.add(str);
                    }
                }
                if (flag == false) {
